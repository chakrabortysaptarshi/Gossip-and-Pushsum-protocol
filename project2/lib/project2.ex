...
defmodule Gossip do
  ...
  def checkConvergence(total, starttime, topology) do
    ...
    checkConvergence(total, starttime, topology)
  end
...
defmodule Project2 do
  def main(args) do
    ...
    if algorithm == "gossip" do
      ...
      :global.sync()
      Gossip.add_gossip(:global.whereis_name(startnodeName), "Gossip", startNode, topology, totalNodes)
      Gossip.checkConvergence(totalNodes, starttime, topology)
    end
    if algorithm == "push-sum" do
      ...
      PushSum.checkConvergence(totalNodes, starttime, topology)
    end
  end
end
